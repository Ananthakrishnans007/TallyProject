# Generated by Django 4.0.6 on 2022-08-24 09:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_under', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tally_app.group_under')),
            ],
        ),
        migrations.CreateModel(
            name='Ledger_Voucher',
            fields=[
                ...
                ('Debit', models.IntegerField(blank=True, default='Null', null=True)),
                ('Credit', models.IntegerField(blank=True, default='Null', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ledger_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tally_app.ledger')),
            ],
        ),
        migrations.CreateModel(
            name='ledger_tax',
